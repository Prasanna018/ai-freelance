...
const WhatAreWeSection = () => {
    return (
        <div id='name' className="mx-auto w-full max-w-[75rem]">
            <div className="flex flex-col items-center gap-3">
                {/* Tag */}
                <div className="border-blackvariant1 text-white  bg-whitevariant2 text-primaryColor font-primaryFont flex w-fit items-center gap-2 rounded-[26463.9375rem] border px-4 py-3 text-base leading-[1.0625rem] font-normal md:text-lg">
                ...
                {/* Heading */}
                <h1 className="font-primaryFont l:text-[4rem] l:-tracking-[0.1rem] text-center text-[2.5rem] leading-[3rem] font-bold text-white md:leading-[4.2rem]">
                    What are we?
                </h1>

                {/* Description */}
                <p className="text-white font-primaryFont text-center text-lg leading-[1.8rem] font-normal -tracking-[0.00625rem] md:text-xl mx-auto w-full max-w-[21.8rem] md:max-w-[34.9375rem]">
            ...
            {/* Features Grid */}
            <div className="l:justify-between l:flex-nowrap mt-[3rem] flex w-full flex-wrap items-center justify-center gap-12 py-12">
                {/* Feature 1 */}
                <div className="l:flex-row flex w-full max-w-[23rem] flex-col items-center gap-6">
